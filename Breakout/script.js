...
function increaseScore() {
  ...
  if (score % (brickRowCount * brickRowCount) === 0 && score % (brickRowCount * brickRowCount) === 45) {
    showAllBricks();
  }
}
...
function showSrc() { //alert("this is detail");
  document.getElementById("srcbox").style.display = "block"; 
  document.getElementById("crtbox").style.display = "none";
}
...
function clrc() {
	document.cookie = "Welcome to Breakout Game!"; alert(document.cookie);
} 
